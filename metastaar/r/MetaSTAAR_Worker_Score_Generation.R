...
cloud_dir_store <- "gs://fc-282d7a75-f309-444a-9e1b-2679f8b67168/TOPMed_F8_Summary_Stat/HDL/Score"
...
MetaSTAAR_worker_score_agds <- function(i, cloud_dir, chr, genofile, variant.id, position, nullobj, segment_size)
{
	...
	system(paste0("gsutil cp /home/jupyter-user/notebooks/Summary_Stat_Score/",output_file_name,".chr",chr,".segment",i,".Rdata ",cloud_dir,"/chr",chr,"/",output_file_name,".chr",chr,".segment",i,".Rdata"))
